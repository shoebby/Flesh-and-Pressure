label alone:
    ...
    f_t "Mae was my trainer for both days, very kind, kind of plain, plainly passionate about her work there."
    ...
    f_t "Usually people just bullshit and half-ass these sorts of jobs."
    show speaker itske smug
    f_t "It almost makes me care as well."
    show speaker itske pouting
    f_t "Maybe it will?"
    show speaker itske smug
    f_t "Nahhh."
    ...
    show speaker itske pouting
    f_t "These days have been good, but tiring."
    f_t "And... Educational."
    ...
    show speaker itske blehhh
    f_t "Some of them hot, most of them... Not so much..."
    show speaker itske tired
    ...
    f "Hmm..."
    f "Sold the Lego..."
    f "Ran out of unbuilt plamo kits..."
    f "No paint..."
    ...
    nvl clear
    show bg kitchen with dissolve
    f_t "I turn off my PC, turn off the kitchen lights..."
    show bg livingroom with dissolve
    ...
    f_t "..."
    show speaker itske bothered
    f_t "No, that's incredibly stupid, I'd already be raped and murdered."
    ...
    show speaker itske focused
    f_t "Sliding my pants and undies down halfway my thighs my dick perks up."
    f_t "It's hard, but it still feels a bit dry..."
    ...
    f_t "But eventually even this thought is overtaken by fear and paranoia."
    ...
    f_t "A few thin ropes of cum shoot onto the bedding. I quiver slightly as a tingling sensation creeps up the base of my cock, and burrows itself into my pelvis."
    ...
    show speaker itske tired
    f_t "Relieved, reassured, and exhausted, I plop down into my own cum."
